...
item.create("botte1", assets["botte1"], 1, {type="equipement", subtype="boot", name="Botte en bois"})
item.create("casque1", assets["casque1"], 1, {type="equipement", subtype="helmet", name="Casque en bois"})
item.create("jambiere1", assets["jambiere1"], 1, {type="equipement", subtype="pant", name="Jambiere en bois"})
item.create("plastron1", assets["plastron1"], 1, {type="equipement", subtype="chestplate", name="Plastron en bois"})
...
item.create("plastron3", assets["plastron3"], 1, {type="equipement", subtype="chestplate", name="Plastron en Fer"})
item.create("botte4", assets["botte4"], 1, {type="equipement", subtype="boot", name="Botte en Or"})
item.create("casque4", assets["casque4"], 1, {type="equipement", subtype="helmet", name="Casque en Or"})
item.create("jambiere4", assets["jambiere4"], 1, {type="equipement", subtype="pant", name="Jambiere en Or"})
item.create("plastron4", assets["plastron4"], 1, {type="equipement", subtype="chestplate", name="Plastron en Or"})
item.create("botte5", assets["botte5"], 1, {type="equipement", subtype="boot", name="Botte en Mythril"})
item.create("casque5", assets["casque5"], 1, {type="equipement", subtype="helmet", name="Casque en Mythril"})
item.create("jambiere5", assets["jambiere5"], 1, {type="equipement", subtype="pant", name="Jambiere en Mythril"})
item.create("plastron5", assets["plastron5"], 1, {type="equipement", subtype="chestplate", name="Plastron en Mythril"})
