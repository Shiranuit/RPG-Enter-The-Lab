...
function load(scene)
    ...
    local torch2 = new(EntityProps(100, 850, assets["torch"], 27, 111, {{0, 95},{0, 111}, {55, 111}, {55, 95}}, 1))
    local robot1 = new(EntityRobot1(200, 850))
    local robot2 = new(EntityRobot1(800, 300))
    local robot3 = new(EntityRobot1(800, 750))
